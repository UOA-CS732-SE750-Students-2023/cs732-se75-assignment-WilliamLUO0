    ...
    <div class="home-container">
        ...
        <main class="left-content">
            ...
            <div class="now-play play-section">
                <h2 class="title">Now in theaters</h2>
            ...
            <div class="recent-play play-section">
                <h2 class="title">Recent Popular Movies</h2>
        ...
        <aside class="right-content">
            ...
            <!-- 口碑榜 -->
            <div class="top-rank">
                <h2 class="title">Weekly Word of Mouth</h2>
            ...
            <!-- 合作 -->
            <div class="coopt">
                <h2 class="title">Cooperation Contact</h2>
                <ul>
                    <li>Film Collaboration: douban@lvming.com</li>
                    <li>TV drama cooperation email: douban@lvming.com</li>
                </ul>
            </div>
