<template>
  <div class="login-container">
    <div class="login-content">
      ...
      <div class="error-tips" v-if="loginInfo.errorInfo">Incorrect username or password</div>
      <div class="tips">LZH/11111111</div>
    </div>
  </div>
</template>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const login = () => {
                if(loginInfo.username == 'LZH' && loginInfo.password == '11111111'){
