<template>
    <div class="movie-comments" v-if="detailData.list.length">
        <h2 class="intro-title">{{title}}'s movie review</h2>
        <div class="scroll-wrap">
            <div class="comment-item" v-for="item in detailData.list || []" :key="item.id">
                <div class="top-content">
                    ...
                    <div class="rankstar" v-if="item.rating && item.rating.value"><span class="rank-text">Seen Before</span><rankstar :score="item.rating.value"></rankstar></div>
