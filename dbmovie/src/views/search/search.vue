<template>
     <div class="search-container">
        <h1 class="page-title">Search for: {{$route.query.searchText}}</h1>
        <div class="serach-result">
            <div v-if="searchList.list.length == 0">No search data</div>
            ...
            <div class="item-content" v-for="item in searchList.list" :key="item.target.id">
                ...
                <div class="left-content">
                    ...
                    <div class="rank-content">
                        ...
                        <div>（{{item.target.rating.count}}people evaluation）</div>
                    </div>
