  ...
  <nav class="nav-wapper">
    <div class="nav-header">
        ...
        <div class="nav-search">
            <input id="inp" placeholder="Search for movies, TV series, variety shows, film makers" v-model.trim="searchText" @keyup.enter.native="goSearch"/>
            <div class="search-btn" @click="goSearch"></div>
        </div>

        <!-- 右边登录 -->
        <div v-if="user.nickname" class="nickname">
          {{user.nickname}}，<a @click="logout">Exit</a>
        </div>
